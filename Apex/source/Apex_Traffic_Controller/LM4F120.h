//*******************************************************
// cme331_LM4F120.h - LM4F120EXL / TMTM4C123GXL Register Definitions
...
#define GPIO_PORTA_ODR          (*((volatile unsigned long *)0x4000450C)) // p.629
#define GPIO_PORTA_AMSEL        (*((volatile unsigned long *)0x40004528)) // p.640
...
#define GPIO_PORTB_AMSEL             (*((volatile unsigned long *)0x40005528)) //640
#define GPIO_PORTB_ODR              (*((volatile unsigned long *)0x4000550C)) // PORT B open drain p.629
...
#define GPIO_PORTC_DIR              (*((volatile unsigned long *)0x40005400)) // p.616
...
// UART0 register map on p.854
#define UART0_DR                  (*((volatile unsigned long *)0x4000C000)) // UART data register, p.856
#define UART0_FR                  (*((volatile unsigned long *)0x4000C018)) // UART Flag register, p.861
#define UART0_IBRD                (*((volatile unsigned long *)0x4000C024)) // UART integer baud rate, p.864
#define UART0_FBRD                (*((volatile unsigned long *)0x4000C028)) // UART fraction baud rate, p.865
#define UART0_LCRH                (*((volatile unsigned long *)0x4000C02C)) // UART line control, p.866
#define UART0_CTL                 (*((volatile unsigned long *)0x4000C030)) // UART control register, p.868
#define UART0_CC                 (*((volatile unsigned long *)0x4000CFC8)) // UART control register, p.892


#define SYSCTL_RCGCGPIO             (*((volatile unsigned long *)0x400FE608)) // System control clock, p.310
#define SYSCTL_RCGCUART             (*((volatile unsigned long *)0x400FE618)) // System control to enable uart, p.314
